...
export async function execute(interaction: ChatInputCommandInteraction) {
  ...
  const resurrectQuotes = [
    ...
    '실손보험 가입하세요. 아, 게임이라 안 되네.',
    '부활 3회 이상이면 다음부턴 선불입니다.',
    '이 병원 구글 리뷰 1.2점... 그래도 여기밖에 없습니다.',
    '사망 진단서 작성 중... 사인: 가챠 중독으로 인한 스트레스',
    '"아 또 왔어?" - 접수 간호사',
  ]
  const healQuotes = [
    '다음에는 좀 덜 맞고 오세요.',
    ...
    '건강보험료가 밀려서 추가 요금 붙었습니다. (농담)',
    '의사: "다음에 오시면 단골 카드 찍어드릴게요"',
    '치료비 영수증 보고 다시 HP가 떨어질 뻔했습니다.',
    '옆 침대 환자: "형도 가챠 중독?"',
    '대기실에 전투에서 진 사람들이 줄 서 있습니다.',
  ]
